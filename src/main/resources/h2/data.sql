...
INSERT INTO RoomItem (price, description, name, maxPeople) VALUES
(700000, '아름다운 전망과 편안한 분위기의 더블룸입니다. 커플이나 비즈니스 여행객에게 적합합니다.', 'VIP룸', 6),
(350000, '넓은 공간과 고급스러운 인테리어의 스위트룸입니다. 가족이나 그룹 여행객에게 이상적입니다.', '디럭스 스위트룸', 4),
(100000, '탁 트인 바다뷰를 가지고 있는 일반룸입니다. 가족이나 그룹 여행객에게 이상적입니다.', '오션뷰 일반룸', 4);
